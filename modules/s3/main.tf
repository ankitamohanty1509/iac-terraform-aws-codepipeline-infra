...
resource "aws_s3_bucket" "terraform_bucket_ankita" {
...
resource "aws_s3_bucket_public_access_block" "allow_public" {
  bucket = aws_s3_bucket.terraform_bucket_ankita.id
    ...
    Statement = [
      {
        ...
        Principal = "*",
        Action    = "s3:GetObject",
        Resource  = "${aws_s3_bucket.terraform_bucket_ankita.arn}/*"
      }
    ]
  })
...
#   value       = aws_s3_bucket.terraform_bucket_ankita.arn
# }
